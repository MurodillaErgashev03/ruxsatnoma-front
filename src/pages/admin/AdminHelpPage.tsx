...
export const AdminHelpPage: React.FC<AdminHelpPageProps> = () => {
  ...
  const faqList = [
    ...
    },
    {
      ...
      a: "TZ 4.2.4 va С24 reglamentiga koʻra, audit loglari bazada WORM Append-Only rejimida saqlanadi. Hattoki `sys_admin` ham auditni oʻchira olmaydi. Noqonuniy oʻchirishga boʻlgan har bir urinish zudlik bilan `RI-06 Kritik Risk-Indikatori` sifatida Bosh Prokuratura 'Raqamli Nazorat' portali hamda SOC xavfsizlik markaziga avtomatik signal yuboradi.",
    },
    {
      q: "Maʻlumotlar bazasi zahiraviy nusxasini (Backup) tiklashda xavfsizlik qoidasi qanday ishlaydi?",
      a: "TZ 4.2.1.5 va С24 (660-satr) talabiga binoan, ilgarigi zahiraviy nusxadan tiklash (Restore) tugmasi bosilganda, tizim avval joriy holatning avtomatik zaxira nusxasini (`Auto Pre-Restore Safety Snapshot`) yaratadi va audit jurnaliga yozadi. Shundan soʻnggina tiklash amali bajariladi.",
    },
    {
    ...
    <div className="space-y-6 font-sans">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-gradient-to-br from-white to-blue-50/40 border border-[#E4E7EA] p-5 rounded-2xl shadow-xs hover:shadow-md transition-all flex items-center justify-between group">
          <div className="space-y-1">
            ...
            <div className="text-base font-bold text-[#1A1F24] tracking-tight">6 ta Interaktiv Video</div>
            <span className="text-xs text-blue-700 font-bold flex items-center gap-1">
              <Video className="w-3.5 h-3.5" /> п. 12.2 TZ Kontekst Yordam
            </span>
          </div>
        ...
        <div className="bg-gradient-to-br from-white to-emerald-50/40 border border-[#E4E7EA] p-5 rounded-2xl shadow-xs hover:shadow-md transition-all flex items-center justify-between group">
          <div className="space-y-1">
            <span className="text-[11px] font-bold text-[#5A646D] uppercase tracking-wider block">Maʻlumotlar Bazasi SLA</span>
      ...
      <div className="bg-white border border-[#E4E7EA] rounded-2xl p-6 shadow-xs flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <h1 className="text-lg font-bold text-[#1A1F24] tracking-tight mt-1.5">Maʻmurlash Yoʻriqnomalari va Texnik Qoʻllab-quvvatlash</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
        <div className="bg-white border border-[#E4E7EA] rounded-2xl p-5 shadow-xs space-y-3 hover:shadow-md transition-all">
          ...
          <div>
            ...
            <h3 className="font-extrabold text-[#1A1F24] text-sm mt-0.5">SysAdmin Maʻmurlash Yoʻriqnomasi v2.4</h3>
        ...
        <div className="bg-white border border-[#E4E7EA] rounded-2xl p-5 shadow-xs space-y-3 hover:shadow-md transition-all">
          ...
          <div>
            ...
            <h3 className="font-extrabold text-[#1A1F24] text-sm mt-0.5">WORM Audit & RI-06 Xavfsizlik Qoʻllanmasi</h3>
            <p className="text-xs text-[#5A646D] mt-1 leading-relaxed">
        ...
        <div className="bg-white border border-[#E4E7EA] rounded-2xl p-5 shadow-xs space-y-3 hover:shadow-md transition-all">
          ...
          <div>
            ...
            <h3 className="font-extrabold text-[#1A1F24] text-sm mt-0.5">PostgreSQL Backup va Tiklash Qoʻllanmasi</h3>
            <p className="text-xs text-[#5A646D] mt-1 leading-relaxed">
      ...
      <div className="bg-white border border-[#E4E7EA] rounded-2xl p-6 shadow-xs space-y-4">
        <div className="flex items-center justify-between border-b border-[#E4E7EA] pb-3">
          ...
          <span className="text-xs text-[#5A646D]">п. 12.2 Kontekst video yordam</span>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 font-sans">
          <div className="bg-[#F8F9FA] border border-[#E4E7EA] rounded-2xl overflow-hidden group">
            ...
            <div className="p-4 space-y-1">
              <h4 className="font-bold text-[#1A1F24] text-xs">PostgreSQL DB Backup va Hot Storage Tiklash</h4>
      ...
      <div className="bg-white border border-[#E4E7EA] rounded-2xl p-6 shadow-xs space-y-4">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-[#E4E7EA] pb-4">
          <div>
            <h3 className="text-lg font-extrabold text-[#1A1F24]">Koʻp Beriladigan Texnik Savollar (SysAdmin FAQ)</h3>
            ...
            <form onSubmit={handleCreateTicket} className="space-y-4">
              ...
              <div className="space-y-1">
                ...
                >
                  ...
                  <option value="DATABASE">PostgreSQL DB & Backup Muammosi</option>
